...
const PROJECTS = [
  {
    name: "Versa-AI",
    description:
      "An AI-powered document interaction platform that enables intelligent PDF conversations, context-aware search, and seamless user experience with a dual-backend architecture.",
  ...
  },
  {
    name: "Microservices",
    description:
      "A microservices architecture that is built to be scalable and reliable. It introduces me to Docker, Kubernetes, Nginx, and Virtual Machine!",
  ...
  },
  {
    ...
    description:
      "A mobile app that is built to be accessible anywhere. It has better UI/UX than its predecessor as well as features and performance improvements.",
            ...
            <div className="flex xs:mt-[400px] lg:mt-[0px] md:flex-row flex-wrap items-end justify-center gap-5">
              {PROJECTS.map((project) => (
                <div className="" key={project.name}>
                  <div className="w-full relative max-w-[300px] h-[350px]">
