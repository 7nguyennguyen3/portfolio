...
const defaultComponents: Options["components"] = {
  ...
  h6: ({ className, node, ...props }) => (
    <h6
      className={cn(
        "my-4 text-sm font-semibold first:mt-0 last:mb-0",
        className
      )}
      {...props}
    />
  ...
  p: ({ className, node, ...props }) => (
    <p
      className={cn(
        "my-4 leading-relaxed text-sm first:mt-0 last:mb-0",
        className
      )}
      {...props}
    />
  ...
  a: ({ className, node, ...props }) => (
    <a
      className={cn(
        "text-primary font-medium underline underline-offset-4 hover:text-primary/80 transition-colors text-sm",
        className
      )}
      {...props}
    />
  ...
  ul: ({ className, node, ...props }) => (
    <ul
      className={cn("my-4 ml-6 text-sm list-disc [&>li]:mt-2", className)}
      {...props}
    />
  ),
  ol: ({ className, node, ...props }) => (
    <ol
      className={cn("my-4 ml-6 text-sm list-decimal [&>li]:mt-2", className)}
      {...props}
    />
  ),
